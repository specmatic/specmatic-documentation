...
More on this [here](/docs/contract_driven_development).
...
* [Programmatically running stub server](/docs/contract_driven_development/service_virtualization#programmatically-starting-stub-server-within-tests)
* [Programmatically running contract tests](/docs/contract_driven_development/contract_testing#programmatically-executing-specmatic-contract-tests)
