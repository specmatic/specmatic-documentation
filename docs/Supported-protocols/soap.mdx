...
- Additionally, this can be achieved programmatically if you are using a JVM-based language. For further details, please refer to [Programmatically Executing Specmatic Contract Tests](../Contract-driven-development/contract_testing#programmatically-executing-specmatic-contract-tests)
...
- Additionally, if you're working with a JVM-based language, this can also be executed programmatically. For more information, please consult [Programmatically Executing Specmatic Mocks](../Contract-driven-development/service_virtualization#programmatically-starting-stub-server-within-tests)
