...
<dependency>
    ...
    <version><!-- TODO: Liquid variable removed: {{ site.specmatic-jms-version }} --></version>
</dependency>
```
...
```shell
implementation("io.specmatic.jms:specmatic-jms-min:<!-- TODO: Liquid variable removed: {{ site.specmatic-jms-version }} -->")
```
