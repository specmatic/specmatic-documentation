...
you can simulate response times with the specified delay in milliseconds, as mentioned in [Delay Simulation](/docs/contract_driven_development/service_virtualization#delay-simulation)

## Strict Mode

Stub may run in strict mode. You can read more about [stub in strict mode here](/docs/contract_driven_development/service_virtualization#strict-mode).
...
You can also specify `host`, `basePath`, and even the complete `baseUrl` in the `consumes` field. For more details, refer to the [Service Virtualization](/docs/contract_driven_development/service_virtualization#specmatic-configuration-with-base-url-host-port-and-path)
