...
Specmatic is a platform and programming language independent executable. We can run it in all CI environments through the [command line interface](../Getting%20Started/cli-quick-start#set-up).
...
![Order Microservices architecture](../../static/img/insights_demo_architecture.png)
...
3. Download and add the following OpenAPI specifications to the repository as depicted above
  ...
  - [Order BFF OpenAPI Spec](pathname://ci_tutorial_spec_files/order_bff.yaml)
  - [Order Domain API OpenAPI Spec](pathname://ci_tutorial_spec_files/order_api.yaml)
...
![Successful contract repo](../../static/img/insights_step1_successful.png)
...
![Successful Client CI Pipeline](../../static/img/insights_step2_1_successful.png)
...
![Successful BFF CI pipeline](../../static/img/insights_step2_2_successful.png)
...
![Success Order API CI pipeline](../../static/img/insights_step2_3_successful.png)
...
Please go through the detailed [Specmatic Insights guide](../Enterprise-onboarding/insights) to integrate Specmatic Insights in your CI/CD pipelines.
...
* [Authentication In CI For HTTPS Git Source](../Contract-driven-development/contract_testing#authentication-in-ci-for-https-git-source)
* [Authentication In CI For SSH Git Source](../Contract-driven-development/contract_testing#authentication-in-ci-for-ssh-git-source)
