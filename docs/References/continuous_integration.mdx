...
Specmatic is a platform and programming language independent executable. We can run it in all CI environments through the [command line interface](/docs/getting_started/cli-quick-start.mdx#set-up).
...
Please go through the detailed [Specmatic Insights guide](/docs/enterprise_onboarding/insights.mdx) to integrate Specmatic Insights in your CI/CD pipelines.
