...
[Enterprise Onboarding - Specmatic License Keys](./insights#step-2-configuring-specmatic-insights) provides detailed instructions on how to set up and use the license key in CI/CD pipelines and automated systems.
