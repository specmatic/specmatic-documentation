...
Similar to [Competing Requests by Identical Values](#competing-requests-by-identical-values), lets see how [data type-based examples](../Contract-driven-development/service_virtualization#data-type-based-examples) could end up competing for some incoming requests.
...
lets see how [data type based examples](../Contract-driven-development/service_virtualization#data-type-based-examples) could end up competing for incoming request in spite of assigning data type to different keys in the request.
