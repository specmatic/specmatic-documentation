...
Please refer to [Specmatic documentation](/docs/references/configuration) for more details about the above `specmatic.yaml` config file.
...
To get a hands-on experience with additional examples, refer to [these](/docs/sample_projects) sample projects.
