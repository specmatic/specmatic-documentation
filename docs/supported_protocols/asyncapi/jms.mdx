...
:::note
If you have the [Specmatic Config](/docs/references/configuration) set up, you can define the specifications in the `consumes` section and utilize `JmsMock.create(host, port)` in your test setup to create the JMS mock.
:::
