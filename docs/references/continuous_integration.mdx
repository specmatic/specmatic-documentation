...
Specmatic is a platform and programming language independent executable. We can run it in all CI environments through the [command line interface](/getting_started/cli-quick-start.mdx#set-up).
