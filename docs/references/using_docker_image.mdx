...
This ensures that the license file is available inside the container and Specmatic can pick it up automatically. For more details, see the [Specmatic License Keys documentation](/enterprise_onboarding/license_key).
