...
<img alt="Contract Testing" src="/img/contract-testing.png" />
...
```bash
<!-- TODO: Liquid variable removed: {{ site.spec_cmd }} --> test employees.yaml --testBaseURL https://my-json-server.typicode.com
```
...
```bash
<!-- TODO: Liquid variable removed: &#123;&#123; site.spec_cmd &#125;&#125; --> test --testBaseURL https://my-json-server.typicode.com employees.yaml
```
...
```bash
<!-- TODO: Liquid variable removed: {{ site.spec_cmd }} --> test --testBaseURL https://my-json-server.typicode.com --strict employees.yaml
```
...
```bash
<!-- TODO: Liquid variable removed: {{ site.spec_cmd }} --> --testBaseURL https://my-json-server.typicode.com --junitReportDir ./test-output
```
...
```bash
<!-- TODO: Liquid variable removed: {{ site.spec_cmd }} --> --testBaseURL https://my-json-server.typicode.com
```
