...
For details on acquiring and managing your license, refer to the [License Key Guide](/docs/enterprise_onboarding/license_key).

## Step 1: Setting up CI/CD Pipelines with Specmatic

Please go through the detailed [Continuous Integration](/docs/references/continuous_integration) guide to set up Specmatic in your CI/CD pipelines for: 
...
- **License Key Invalid or Missing:** Ensure your license key is correctly configured and not expired. Refer to the [License Key Guide](/docs/enterprise_onboarding/license_key).
