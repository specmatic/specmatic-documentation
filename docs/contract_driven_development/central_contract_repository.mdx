...
<img alt="Central Contract Repository" src="/img/Central-Contract-Repo.png" />
...
Both consumers and providers can leverage the specifications in the Central Contract Repository by listing it in [Specmatic configuration](/docs/references/configuration). Example:
...
[**Specmatic Configuration in detail**](/docs/references/configuration)
